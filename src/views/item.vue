						...
						<div class="gallery">
							<div class="thumbnail">
								<ul>
									...
									<li :class="{'on':index==imgIndex}" @click="tableImg(index)" v-for="(img,index) in itemInfo.ali_image" :key="index">
										<!-- 循环图片和拼接图片大小-->
							...
							<div class="thumb">
								<ul>
									...
									<li :class="{'on':index==imgIndex}" v-for="(img,index) in itemInfo.ali_images" :key="index">
										<!-- 循环图片和拼接图片大小-->
										<img v-lazy="img" width="440px" height="440px"></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="banner">
						...
						<div class="sku-dynamic-params-panel">
							...
							<div class="sku-dynamic-params clear">
								...
								<el-input-number v-model="count" @change="handleChange" :min="1" :max="5" label="描述文字"></el-input-number>
								</div>
							<!-- </div> -->
						</div>
